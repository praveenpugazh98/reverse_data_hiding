...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        try
        {
            ...
            qry="select receiver from detail where uname='"+jTextField3.getText()+"'";
               ...
               if(rs.next())
               {
                   send=rs.getString("receiver");
               }
               else
               {
                   JOptionPane.showMessageDialog(null, "sender "+jTextField3.getText()+" is not Exists..");
               }
            System.out.println(send);
            if(send.equalsIgnoreCase(jTextField1.getText()))
            {
                ProgDecryption mm=new ProgDecryption();
                //mm.setVisible(true);
            this.setVisible(false);
            }
            else
            {
                  JOptionPane.showMessageDialog(null, "Sender or receiver is invalid");
            }
            //mm.setVisible(true);
